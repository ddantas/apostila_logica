...
% Adicionado para permitir a inserção de tableaux semânticos
% ddantas, 06/12/2020
%\usepackage[tableaux]{prooftrees}
\usepackage{prooftrees}

% Adicionado para fazer um teste
% ddantas, 26/06/2021
\usepackage{blindtext}

% Adicionado para permitir páginas com margens variáveis
% ddantas, 29/09/2023
\usepackage{geometry}
...
\newcommand{\EXERCICIOS}{{\noindent \bf \hspace{9pt} Exercícios}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Capítulo: Tableaux semânticos na lógica de predicados
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
